...
// import OnboardRevirt from './onboard/onboardRevirt'
...
//         <Switch>
//           <Route path = "/" exact>
//             <OnboardRevirt setUserName = {setUserName}/>
//           </Route>
...
import OnboardRevirt from './onboard/onboardRevirt'
import JoinGame from './onboard/joingame'
import ChessGameWrapper from './chess/ui/chessgame'
/*
 *  Frontend flow: 
 * 
 * 1. user first opens this app in the browser. 
      ...
      <Router>
        <Switch>
          ...
          <Route path = "/user/:username" exact>
            <OnboardRevirt setUserName = {setUserName} setSpectator ={setSpectator}/>
          </Route>
          <Route path = "/game/:gameid" exact>             
          {/* {didRedirect ?  */}
              <React.Fragment>
                    <JoinGame userName = {userName} isCreator = {true} /> {/* write an event for isCreator  */}
                    <ChessGameWrapper myUserName = {userName} spectator = {spectator}  />
              </React.Fragment> 
              {/* : */}
              {/* <JoinRoom />} */}
          </Route>
